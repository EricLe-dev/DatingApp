...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddPhotoForUser(int userId, [FromForm]PhotoForCreationDto photoForCreationDto)
        {
            ...
            userFromRepo.Photos.Add(photo); //save photo here
        ...
        public async Task<IActionResult> DeletePhoto(int userId, int id)
        {
            ...
            if(photoFromRepo.PublicId != null) // check if the real photo is stored on cloudinary
            {
                //delete image on the cloud
                var deletePrams = new DeletionParams(photoFromRepo.PublicId);
